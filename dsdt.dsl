 ...
 *
 * Disassembly of dsdt.dat, Tue Apr  7 14:32:13 2026
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00019A35 (105013)
 *     Revision         0x02
 *     Checksum         0xA0
 *     OEM ID           "HPQOEM"
 *     OEM Table ID     "8A3E    "
 ...
 */
DefinitionBlock ("", "DSDT", 2, "HPQOEM", "8A3E    ", 0x01072009)
{
    ...
    External (_SB_.PCI0.SBRG.EC0_.GPUT, IntObj)
    ...
    Name (DTPT, Zero)
    Name (TTDP, One)
    Name (TPMB, 0xB6749000)
    Name (TPBS, 0x4000)
    Name (TPMC, 0xB674D000)
    Name (TPCS, 0x4000)
    Name (TPMM, 0xFD210510)
    Name (FTPM, 0xFD210510)
    Name (PPIM, 0xB6B01F18)
    Name (PPIL, 0x1C)
    Name (AMDT, One)
    Name (TPMF, One)
    Name (PPIV, One)
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0xB6B01D98, 0x10)
    ...
    Scope (_GPE)
    {
        ...
        {
            If ((\_SB.PCI0.SBRG.EC0.GPUT == 0x05))
            {
                If ((SLPF == Zero))
                {
        ...
        {
            If ((\_SB.PCI0.SBRG.EC0.GPUT != 0x07))
            {
                If ((SLPF == Zero))
                {
                    Notify (\_SB.PCI0.GPP0.PEGP, 0x81) // Information Change
    ...
    OperationRegion (EXBU, SystemMemory, 0xB6B06018, 0x1008)
    ...
    Method (HWMC, 2, NotSerialized)
    {
        ...
        If ((SGIN == 0x55434553))
        {
            ...
            If ((COMD == One))
            {
                ...
                If ((CMDT == 0x4C))
                {
                    Local2 = \_SB.WMID.GTPS ()
                    RETC = Zero
                }

                If ((CMDT == 0x4D))
                {
                    Local2 = \_SB.WMID.GPCS ()
                    RETC = Zero
                }
        ...
        Device (WMID)
        {
            ...
            Method (GM21, 0, NotSerialized)
            {
                ...
                Else
                {
                    ...
                    DerefOf (Local0 [0x02]) [One] = ^^NPCF.DTGP /* External reference */
                    If ((^^PCI0.SBRG.EC0.ECON == One))
                    {
    ...
    Method (STTR, 1, Serialized)
    {
        ...
        {
            If ((0x05 == \_SB.PCI0.SBRG.EC0.GPUT))
            {
                Switch (Arg0)
                {
                    Case (Zero)
                    {
                        ...
                        \_SB.DPTC (0x22, 0x2A00)
                        \_SB.DPTC (0x23, 0x3300)
                        \_SB.DPTC (0x24, 0x078E)
                        \_SB.DPTC (0x25, 0x34E5)
                        \_SB.DPTC (0x26, 0xF1)
                        \_SB.DPTC (0x27, 0x02AF)
                        \_SB.DPTC (0x28, 0x000000FFFFFFFEED)
                        \_SB.DPTC (0x29, 0x0282)
                        \_SB.DPTC (0x2A, 0x026F)
                        \_SB.DPTC (0x2B, 0x000000FFFFFFFE90)
                        \_SB.DPTC (0x2C, 0x2B49)
                        \_SB.DPTC (0x2D, 0x0DD4)
                    ...
                    Case (One)
                    {
                        \_SB.DPTC (0x20, 0x07AE)
                        \_SB.DPTC (0x21, 0x07AE)
                        \_SB.DPTC (0x22, 0x2D00)
                        \_SB.DPTC (0x23, 0x3500)
                        \_SB.DPTC (0x24, 0x078E)
                        \_SB.DPTC (0x25, 0x34E5)
                        \_SB.DPTC (0x26, 0x011D)
                        \_SB.DPTC (0x27, 0x0341)
                        \_SB.DPTC (0x28, 0x000000FFFFFFFED8)
                        \_SB.DPTC (0x29, 0x0312)
                        \_SB.DPTC (0x2A, 0x01CB)
                        \_SB.DPTC (0x2B, 0x000000FFFFFFFE9A)
                        \_SB.DPTC (0x2C, 0x13D9)
                        \_SB.DPTC (0x2D, 0x0EC0)
                        \_SB.DPTC (0x2E, 0x88B8)
                    }
                    Case (0x03)
                    {
                        \_SB.DPTC (0x20, 0x07AE)
                        \_SB.DPTC (0x21, 0x07AE)
                        \_SB.DPTC (0x22, 0x2E00)
                        \_SB.DPTC (0x23, 0x3100)
                        \_SB.DPTC (0x24, 0x078E)
                        \_SB.DPTC (0x25, 0x34E5)
                        \_SB.DPTC (0x26, 0x032F)
                        \_SB.DPTC (0x27, 0xEF)
                        \_SB.DPTC (0x28, 0x000000FFFFFFFE1E)
                        \_SB.DPTC (0x29, 0x03FE)
                        \_SB.DPTC (0x2A, 0x87)
                        \_SB.DPTC (0x2B, 0x000000FFFFFFFE71)
                        \_SB.DPTC (0x2C, 0x365A)
                        \_SB.DPTC (0x2D, 0x20E5)
                        \_SB.DPTC (0x2E, 0x61A8)
                    }

                }
            }
            ElseIf ((0x07 == \_SB.PCI0.SBRG.EC0.GPUT))
            {
                Switch (Arg0)
                {
                    Case (Zero)
                    {
                        ...
                        \_SB.DPTC (0x21, 0x07AE)
                        \_SB.DPTC (0x22, 0x2D00)
                        \_SB.DPTC (0x23, 0x2F00)
                        \_SB.DPTC (0x24, 0x078E)
                        \_SB.DPTC (0x25, 0x34E5)
                        \_SB.DPTC (0x26, 0x019E)
                        \_SB.DPTC (0x27, 0x036C)
                        \_SB.DPTC (0x28, 0x000000FFFFFFFE34)
                        \_SB.DPTC (0x29, 0x0146)
                        \_SB.DPTC (0x2A, 0xB7)
                        \_SB.DPTC (0x2B, 0x000000FFFFFFFFEB)
                        \_SB.DPTC (0x2C, 0x0C66)
                        \_SB.DPTC (0x2D, 0x4658)
                        \_SB.DPTC (0x2E, 0x000124F8)
                    }
                    Case (One)
                    {
                        \_SB.DPTC (0x20, 0x07AE)
                        \_SB.DPTC (0x21, 0x07AE)
                        \_SB.DPTC (0x22, 0x2D00)
                        \_SB.DPTC (0x23, 0x2D00)
                        \_SB.DPTC (0x24, 0x21)
                        \_SB.DPTC (0x25, 0x2666)
                        \_SB.DPTC (0x26, 0x1F)
                        \_SB.DPTC (0x27, 0x0574)
                        \_SB.DPTC (0x28, 0x000000FFFFFFFEBC)
                        \_SB.DPTC (0x29, 0x66)
                        \_SB.DPTC (0x2A, 0x01CF)
                        \_SB.DPTC (0x2B, 0x09)
                        \_SB.DPTC (0x2C, 0x000000FFFFFFEB29)
                        \_SB.DPTC (0x2D, 0x42A0)
                        \_SB.DPTC (0x2E, 0x00015F90)
                    }
                    Case (0x03)
                    {
                        \_SB.DPTC (0x20, 0x07AE)
                        ...
                        \_SB.DPTC (0x24, 0x078E)
                        \_SB.DPTC (0x25, 0x34E5)
                        \_SB.DPTC (0x26, 0x036E)
                        \_SB.DPTC (0x27, 0x017A)
                        \_SB.DPTC (0x28, 0x000000FFFFFFFDAB)
                        \_SB.DPTC (0x29, 0x0331)
                        \_SB.DPTC (0x2A, 0x011E)
                        \_SB.DPTC (0x2B, 0x000000FFFFFFFE7E)
                        \_SB.DPTC (0x2C, 0x241F)
                        \_SB.DPTC (0x2D, 0x2556)
                        \_SB.DPTC (0x2E, 0xBF68)
                    }
    ...
    Scope (_SB.WMID)
    {
        OperationRegion (MPBS, SystemMemory, 0xFF029000, 0x08)
        ...
        ThermalZone (THRM)
        {
            Method (_TMP, 0, NotSerialized)  // _TMP: Temperature
            {
                If (\_SB.PCI0.SBRG.EC0.ECON)
                {
                    ...
                    Return ((0x0AAC + (\_SB.PCI0.SBRG.EC0.RTMP * 0x0A)))
                }
                Else
                {
    ...
    Scope (_SB)
    {
        ...
        OperationRegion (ITE2, SystemIO, 0x66, One)
    ...
    Scope (_SB.PCI0.SBRG)
    {
        Device (EC0)
        {
                ...
                ElseIf ((0x07 == GPUT))
                {
                    If (SW2S)
                    {
                        Switch (Local0)
                        {
                            Case (Zero)
                            {
                                DPTC (0x05, 0x00012CC8)
                                DPTC (0x06, 0x0001A1F8)
                                DPTC (0x07, 0x00017700)
                                DPTC (0x13, 0xD2F0)
                            }
                            Case (One)
                            {
                                DPTC (0x05, 0x000124F8)
                                DPTC (0x06, 0x00019A28)
                                DPTC (0x07, 0x00016F30)
                                DPTC (0x13, 0xAFC8)
                            }
                            Case (0x02)
                            {
            ...
            Method (PWLD, 0, Serialized)
            {
                If (SW2S)
                {
                    If ((0x07 == GPUT))
                    {
                        DPTC (0x2E, 0x000124F8)
                    }
                }
                ElseIf ((0x07 == GPUT))
                {
    ...
    Scope (_SB.PCI0.SBRG)
    {
        Device (PS2K)
        {
            ...
            Method (_DSW, 1, NotSerialized)  // _DSW: Device Sleep Wake
            {
                KBWU = Arg0
            }
        }
    ...
    Scope (_SB)
    {
        ...
        Method (S34S, 1, NotSerialized)
        {
            If (^PCI0.SBRG.EC0.ECON)
            {
                ...
                ^PCI0.SBRG.EC0.PSKB = One
                ^PCI0.SBRG.EC0.PSTP = One
                If (^PCI0.GPP1.XPDV.PSWF)
                {
    ...
    Scope (_SB.I2CD)
    {
        ...
        {
            Name (_ADR, One)  // _ADR: Address
            Name (_HID, "ELAN0787")  // _HID: Hardware ID
            ...
            Method (_DSM, 4, Serialized)  // _DSM: Device-Specific Method
            {
                ...
                ElseIf ((Arg0 == ToUUID ("d93e4d1c-58bb-493c-a06a-605a717f9e2e") /* Unknown UUID */))
                {
                    Switch (ToInteger (Arg2))
                    {
                        Case (Zero)
    ...
    Scope (_SB.PCI0.GPP3.WLAN)
    {
        ...
        If ((MVID == 0x14C3))
        {
            ...
            Method (MTDS, 0, Serialized)
            {
                ...
                Return (MTPG) /* \_SB_.PCI0.GPP3.WLAN.MTDS.MTPG */
            }
            ...
            Method (MTAG, 0, Serialized)
            {
                ...
                Return (AGPG) /* \_SB_.PCI0.GPP3.WLAN.MTAG.AGPG */
            }
            ...
            Method (MTCL, 0, Serialized)
            {
                ...
                Return (CLPG) /* \_SB_.PCI0.GPP3.WLAN.MTCL.CLPG */
            }
            ...
            Method (MTCC, 0, Serialized)
            {
                ...
                Return (CCPG) /* \_SB_.PCI0.GPP3.WLAN.MTCC.CCPG */
            }
        }
    }
}
